...
mask_dir = join(root_dir, f"train2017_split_{split_num}_with_masks_v20_seed1")
bbox_dir = join(root_dir, f"train2017_split_{split_num}_original_bbox")
save_dir = join(root_dir, f"train2017_split_{split_num}_generated_bbox_res{bbox_target_size}_script{suffix}_v20_seed1")
...
def rebalanced_select_sku(each_sku_bbox_path_dict, bbox_num, box_num_per_sku_info):
    ...
    for sku in box_num_per_sku_info:
        ...
        probs += [1/box_num_per_sku_info[sku]+1.0]
