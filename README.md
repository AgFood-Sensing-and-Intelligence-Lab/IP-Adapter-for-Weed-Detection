...
The combination of synthetic data, generated by the IP-adpater-based stable diffusion, with with real-world data, achieve an improved mAP@50:95 of 1.26% over by only using real-world images.
